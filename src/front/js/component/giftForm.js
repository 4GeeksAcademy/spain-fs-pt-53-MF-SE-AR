...
export const GiftForm = ({ isEditing }) => {
    ...
    const handleSubmit = evt => {
        evt.preventDefault();
        console.log("falta la funcion para actualizar los datos")
        // const url = isEditing ? `${process.env.BACKEND_URL}/user/${uid}/giftlist/${lid}/edit/${gid}` : `${process.env.BACKEND_URL}/user/${uid}/giftlist/${lid}/new-gift`;
